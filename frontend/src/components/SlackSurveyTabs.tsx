          ...
          <div className={!slackIntegration ? "" : "border-t pt-4"}>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-sm text-neutral-700"><strong className="text-neutral-900">Authorize the app</strong> to deliver 3-question burnout surveys via Slack</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-sm text-neutral-700"><strong className="text-neutral-900">Team members receive surveys</strong> via automated DMs or by typing <code className="bg-neutral-200 px-1 rounded text-xs text-neutral-900">/oncall-health</code></p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-sm text-neutral-700"><strong className="text-neutral-900">Survey data automatically integrates</strong> with your burnout analysis to validate automated detection patterns</p>
                </div>
              </div>
            </div>
          </div>
